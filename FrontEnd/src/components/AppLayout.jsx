...
import {
  ...
  HelpCircle, LogOut, ChevronDown, Search, Shield
} from 'lucide-react'
        ...
        <div style={{ padding: '18px 20px', borderBottom: '1px solid var(--border-light)' }}>
          <div className="flex items-center gap-2" style={{ marginBottom: 4 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 10, color: 'var(--text-4)', fontWeight: 600, letterSpacing: '0.04em', textTransform: 'uppercase', marginTop: 1 }}>Enterprise Security</div>
            </div>
          </div>
        </div>
