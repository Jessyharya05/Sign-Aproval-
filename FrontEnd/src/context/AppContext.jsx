...
export const MOCK_USERS = [
  { id: 'u1', name: 'Ricky Takahindangen', email: 'ricky@company.com', initials: 'RT', nik: '3201234567890001', verified: true, avatarColor: '#9B3A1A', role: 'Developer' },
  { id: 'u2', name: 'Sarah Jenkins', email: 'sarah@company.com', initials: 'SJ', nik: '3201234567890002', verified: true, avatarColor: '#2A6496', role: 'Project Manager' },
  { id: 'u3', name: 'Michael Kim', email: 'michael@company.com', initials: 'MK', nik: '3201234567890003', verified: true, avatarColor: '#27723A', role: 'Legal Counsel' },
  { id: 'u4', name: 'David Chen', email: 'david@company.com', initials: 'DC', nik: '3201234567890004', verified: true, avatarColor: '#6B3A9B', role: 'CFO' },
]
